...
require('codemirror/mode/javascript/javascript');
 ...
 class Array9 extends Component {
    ...
    render() {
        ...
        return (
        <div>
              <h5>C Program to Implement a Queue using an Array</h5>
            <div className="containers">
                <div className="row">
                    <div className="col-6 ">
                    <h2>Problem Description</h2>
                 <p>C program implements the queue operations using array.</p>
